...
#define Poly_degree 4096  // 多项式的次数为4096
#define Logt 20  // Logt的值为20
#define Seal_insert_max_size  10240  // SEAL密文计算插入的最大数据量为10240
#define use_symmetric  true  // 使用对称加密
#define use_batching  true  // 使用批量加密
#define use_recursive_mod_switching  true  // 使用递归模切换
static int buff_size = 10000;
static int reply_max_size = 50000; // 每个块的大小
...
bool writeVectorToFile(const std::string& filename, const std::vector<uint8_t>& data);